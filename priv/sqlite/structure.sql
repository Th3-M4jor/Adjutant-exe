...
CREATE TABLE IF NOT EXISTS "created_commands" ("name" TEXT NOT NULL PRIMARY KEY, "state" BLOB NOT NULL, "inserted_at" TEXT_DATETIME NOT NULL, "updated_at" TEXT_DATETIME NOT NULL);
