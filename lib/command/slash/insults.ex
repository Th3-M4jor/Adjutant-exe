defmodule BnBBot.Command.Slash.Insults do
  @moduledoc """
  ...
  @owner_cmd_scope Application.compile_env!(:elixir_bot, :owner_command_scope)

  use BnBBot.Command.Slash, permissions: :owner, scope: @owner_cmd_scope
  ...
  defp add_insult(inter, insult) do
    new_insult = BnBBot.PsychoEffects.Insults.add_new!(insult)
  ...
  defp remove_insult(inter, id) do
    insult = BnBBot.PsychoEffects.Insults.get_by_id(id)
    ...
    case btn_response do
      {btn_inter, "yes"} ->
        BnBBot.PsychoEffects.Insults.delete(insult)
  ...
  defp list_insults(inter) do
    content =
      BnBBot.PsychoEffects.Insults.get_all()
  ...
  defp edit_insult(inter, id, insult) do
    old_insult = BnBBot.PsychoEffects.Insults.get_by_id(id)
    ...
    case btn_response do
      {btn_inter, "yes"} ->
        BnBBot.PsychoEffects.Insults.update!(old_insult, insult)
