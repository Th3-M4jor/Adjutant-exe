defmodule BnBBot.Command.Slash.PsychoEffects do
  @moduledoc """
  ...
  @cmd_scope Application.compile_env!(:elixir_bot, :primary_guild_id)

  use BnBBot.Command.Slash, permissions: [:admin, :owner], scope: @cmd_scope
  ...
  defp allow(inter) do
    ...
    BnBBot.PsychoEffects.Channel.allow_channel(channel_id)
  end
  ...
  def deny(inter) do
    ...
    BnBBot.PsychoEffects.Channel.deny_channel(%{
      id: channel_id,
      guild_id: guild_id,
      set_by: user_id
    })
